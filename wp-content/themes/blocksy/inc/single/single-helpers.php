...
function blocksy_author_social_channels() {
	...
	<div class="<?php echo esc_attr($class); ?>">
		...
		<?php if ( $website ) { ?>
			<a href="<?php echo esc_url( $website ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Website icon">
		...
		<?php if ( $twitter ) { ?>
			<a href="<?php echo esc_url( $twitter ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Twitter icon">
		...
		<?php if ( $facebook ) { ?>
			<a href="<?php echo esc_url( $facebook ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Facebook icon">
		...
		<?php if ( $linkedin ) { ?>
			<a href="<?php echo esc_url( $linkedin ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="LinkedIn icon">
		...
		<?php if ( $dribbble ) { ?>
			<a href="<?php echo esc_url( $dribbble ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Dribbble icon">
		...
		<?php if ( $instagram ) { ?>
			<a href="<?php echo esc_url( $instagram ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Instagram icon">
				<svg class="ct-icon" width="12" height="12" viewBox="0 0 20 20"><path d="M13.3 10c0 1.8-1.5 3.3-3.3 3.3S6.7 11.8 6.7 10 8.2 6.7 10 6.7s3.3 1.5 3.3 3.3zm6.6-4.2v8.4c0 3.2-2.6 5.8-5.8 5.8H5.8C2.6 20 0 17.4 0 14.1V5.8C0 2.6 2.6 0 5.8 0h8.4c3.2 0 5.8 2.6 5.7 5.8zM15 10c0-2.8-2.2-5-5-5s-5 2.2-5 5 2.2 5 5 5 5-2.2 5-5zm1.6-5.8c0-.4-.4-.8-.8-.8s-.8.4-.8.8.4.8.8.8c.5 0 .8-.4.8-.8z"/></svg>
			</a>
		<?php } ?>

		<?php if ( $pinterest ) { ?>
			<a href="<?php echo esc_url( $pinterest ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Pinterest icon">
				<svg class="ct-icon" width="12" height="12" viewBox="0 0 20 20"><path d="M10 0C4.5 0 0 4.5 0 10c0 4.1 2.5 7.6 6 9.2 0-.7 0-1.5.2-2.3s1.3-5.4 1.3-5.4-.3-.6-.3-1.6c0-1.5.9-2.6 1.9-2.6.9 0 1.3.7 1.3 1.5 0 .9-.6 2.3-.9 3.5-.3 1.1.5 1.9 1.6 1.9 1.9 0 3.2-2.4 3.2-5.3 0-2.2-1.5-3.8-4.2-3.8-3 0-4.9 2.3-4.9 4.8 0 .9.3 1.5.7 2 .1.1.2.2.1.5 0 .2-.2.6-.2.8-.1.3-.3.3-.5.3-1.4-.6-2-2.1-2-3.8 0-2.8 2.4-6.2 7.1-6.2 3.8 0 6.3 2.8 6.3 5.7 0 3.9-2.2 6.9-5.4 6.9-1.1 0-2.1-.6-2.4-1.2 0 0-.6 2.3-.7 2.7-.2.8-.6 1.5-1 2.1.9.2 1.8.3 2.8.3 5.5 0 10-4.5 10-10S15.5 0 10 0z"/></svg>
			</a>
		<?php } ?>

		<?php if ( $wordpress ) { ?>
			<a href="<?php echo esc_url( $wordpress ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="WordPress icon">
		...
		<?php if ( $github ) { ?>
			<a href="<?php echo esc_url( $github ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="GitHub icon">
		...
		<?php if ( $medium ) { ?>
			<a href="<?php echo esc_url( $medium ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Medium icon">
		...
		<?php if ( $youtube ) { ?>
			<a href="<?php echo esc_url( $youtube ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="YouTube icon">
		...
		<?php if ( $vimeo ) { ?>
			<a href="<?php echo esc_url( $vimeo ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Vimeo icon">
		...
		<?php if ( $vkontakte ) { ?>
			<a href="<?php echo esc_url( $vkontakte ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Vkontakte icon">
		...
		<?php if ( $odnoklassniki ) { ?>
			<a href="<?php echo esc_url( $odnoklassniki ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="Odnoklassniki icon">
		...
		<?php if ( $tiktok ) { ?>
			<a href="<?php echo esc_url( $tiktok ); ?>" target="_blank" rel="noopener noreferrer nofollow" aria-label="TikTok icon">
